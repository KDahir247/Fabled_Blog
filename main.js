...
var $author$project$Main$init = F3(
	function (_v0, _v1, navKey) {
		...
		var navbarCmd = _v2.b;
		return _Utils_Tuple2(
			{navKey: navKey, navState: navState},
			navbarCmd);
	});
...
var $author$project$Main$subscription = function (model) {
	return A2($rundis$elm_bootstrap$Bootstrap$Navbar$subscriptions, model.navState, $author$project$Main$NavbarMsg);
};
		...
		A2(
					...
					$rundis$elm_bootstrap$Bootstrap$Navbar$dropdown(
					{
						...
						items: _List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('CPU Architecture')
									])),
								A2(
								$rundis$elm_bootstrap$Bootstrap$Navbar$dropdownItem,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('GPU Architecture')
									]))
							]),
						toggle: A2(
			...
			A3(
				...
				A2(
					...
					A3($avh4$elm_color$Color$rgb255, 69, 69, 69),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[$rundis$elm_bootstrap$Bootstrap$Grid$Col$xs9, $rundis$elm_bootstrap$Bootstrap$Grid$Col$md8]),
						_List_fromArray(
							[
								...
								A3(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text('first blog post')
												])),
...
var $rundis$elm_bootstrap$Bootstrap$ButtonGroup$LinkButtonItem = function (a) {
	return {$: 'LinkButtonItem', a: a};
};
...
var $rundis$elm_bootstrap$Bootstrap$ButtonGroup$linkButton = F2(
	function (options, children) {
		return $rundis$elm_bootstrap$Bootstrap$ButtonGroup$LinkButtonItem(
			A2($rundis$elm_bootstrap$Bootstrap$Button$linkButton, options, children));
	});
...
var $rundis$elm_bootstrap$Bootstrap$ButtonGroup$linkButtonGroupItem = F2(
	function (options, items) {
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Row$rightMd = A2($rundis$elm_bootstrap$Bootstrap$Grid$Internal$rowHAlign, $rundis$elm_bootstrap$Bootstrap$General$Internal$MD, $rundis$elm_bootstrap$Bootstrap$General$Internal$Right);
...
var $author$project$Main$social_platform = function (model) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'background-color', '#666262')
			]),
		_List_fromArray(
			[
				A2(
				$rundis$elm_bootstrap$Bootstrap$Grid$row,
				_List_fromArray(
					[$rundis$elm_bootstrap$Bootstrap$Grid$Row$rightMd]),
				_List_fromArray(
					[
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$href('https://www.tiktok.com/@farsawir')
															])),
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$src('./resources/images/tick_tok_icon.png')
															]),
														_List_Nil)
													])),
												A2(
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$href('https://www.youtube.com/channel/UC_GxA_40R305OZkr2o5ka3A/featured')
															])),
														$rundis$elm_bootstrap$Bootstrap$Button$small
													]),
												_List_fromArray(
...
var $author$project$Menu$viewFooter = A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$social_platform(model),
						$author$project$Main$pageHome(model),
						$author$project$Menu$viewFooter
					]))
			]),
		title: 'Fable Blog'
	};
